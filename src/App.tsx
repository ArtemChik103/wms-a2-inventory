...
export function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col text-slate-900 font-sans selection:bg-blue-600 selection:text-white">
      {/* Header */}
      <Header totalItemsCount={items.length} />
            ...
            <button
              ...
              onClick={() => {
                ...
                const newItem: InventoryItem = {
                  ...
                  history: [{ time: 'Только что', event: 'Создана карточка товара', user: 'Оператор А2' }],
                };
      ...
      <footer className="border-t border-slate-200 bg-white py-4 mt-auto">
        <div className="mx-auto flex max-w-7xl flex-col sm:flex-row items-center justify-between px-4 sm:px-6 lg:px-8 text-xs text-slate-500 gap-2">
          ...
          <div className="flex items-center gap-4 text-slate-400 text-[11px]">
            <span>Горячая клавиша: <kbd className="font-mono bg-slate-100 px-1 py-0.5 rounded border border-slate-200">/</kbd> (поиск)</span>
            <span>·</span>
